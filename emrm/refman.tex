...
\includegraphics{../assets/images/examples/logo.png}

Converts to:

\includegraphics{../assets/images/examples/crossstitch_logo.png}
...
%\lstinputlisting{build_libembroidery.sh}
...
#\subsection{Tactile art and braille support}
